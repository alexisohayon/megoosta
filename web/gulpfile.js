...
// Compile Jade templates into HTML files
gulp.task('_templates', function() {
	gulp.src('src/templates/**/*.jade')
		.pipe(jade())
        .pipe(templateCache({module: 'ng', moduleSystem: 'Browserify'}))
...
gulp.task('_build', ['_assets', '_css-build', '_css-vendor-build', '_templates', '_modernizr-build',
...
gulp.task('_watch', function () {
    gulp.watch('src/styl/**/*.styl', ['_css-build']);

    gulp.watch('src/templates/**/*.jade', ['_templates']);
